...
<body>
 ...
 <div id="navbar" class="navbar-collapse collapse">
    ...
    <label class="navbar-text text-center text-primary" style="vertical-align:10px;font-size:medium "></label>
...
<div class="modal fade" id="squarespaceModal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
 ...
 <li class="sidebar-brand">
 <a href="ourskill.php" class="navbar-brand">
 ...
 <li>
 <a href="ourskill.php"><span class="glyphicon glyphicon-home" aria-hidden="true"></span> Home</a>
 </li>
 <!--
 <li>
