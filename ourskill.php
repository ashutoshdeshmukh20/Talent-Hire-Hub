...
<body>
 ...
 <div id="navbar" class="navbar-collapse collapse">
    ...
    <label class="navbar-text text-center text-primary" style="vertical-align:10px;font-size:medium ">Talent Hire Hub </label>
...
<div class="modal fade" id="squarespaceModal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
 ...
 <li>
 <a href="ourskill.php"><span class="glyphicon glyphicon-home" aria-hidden="true"></span> <font style="color:white"> Home </font></a>
 </li>
 <!--
 <li>
...
?>		<form method="post">
		<div class="panel-heading">Skills / Capabilities</div>
	</div><label></label>
	<textarea name="skill" rows='5' cols="100" placeholder="Enter Your Skills / Capabilities" ><?php echo $res['skill']; ?></textarea>
<BR/><BR>
...
<label>DETAILS ABOUT YOUR PREVIOUS WORK :</label><br>
<textarea name="project" rows='4' cols="100"  placeholder="Enter your details about your previous work here"><?php echo $res['work']; ?></textarea>
<BR/><BR>
