...
<body>
 ...
 <div id="navbar" class="navbar-collapse collapse">
    ...
    <label class="navbar-text text-center text-primary" style="vertical-align:10px;font-size:medium ">Hello! <font style="font-size:16px"> <?php echo $_SESSION["name"]; ?></font> </label>
...
<div class="modal fade" id="squarespaceModal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
 ...
 <li class="sidebar-brand">
 <a href="notification,php" class="navbar-brand">
...
<div class="col-lg-8">
	 <div class="col-lg-12">
           <div class="panel panel-default">
           <div class="panel-heading"><h2 class="text-left text-primary"> Skills/Capabilities</h2></div>
		<form method="post">
	<textarea name="skill" rows='5' cols="150" style="width:100%" placeholder="Enter Your Skills..." ><?php echo $row['skill']; ?></textarea>
</div>
<hr/>
